...
*This is the fifth entry of the trail. The fourth — the water itself moving, the tide, the parting around the hand — is kept in [readme-archive/README-2026-08-31-iter04.md](README-2026-08-31-iter04.md). That one keeps the third, and so on back to the first. The trail holds one step at a time; anyone who wants to walk the whole way back still can.*
