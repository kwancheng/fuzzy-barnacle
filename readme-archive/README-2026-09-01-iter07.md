...
*This is the seventh entry of the trail. The sixth — the day of the water, the night, the colony's own small light, the hand as the only lamp there is — is kept in [readme-archive/README-2026-08-31-iter06.md](README-2026-08-31-iter06.md). That one keeps the fifth, and so on back to the first. The trail holds one step at a time; anyone who wants to walk the whole way back still can.*
