...
*This is the fourth entry of the trail. The third — the time that ran through the colony, the growing, the traces, the forgetting — is kept in [readme-archive/README-2026-08-31-iter03.md](README-2026-08-31-iter03.md). That one keeps the second, and so on back to the first. The trail holds one step at a time; anyone who wants to walk the whole way back still can.*
